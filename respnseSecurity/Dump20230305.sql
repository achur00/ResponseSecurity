...
INSERT INTO `contacts` VALUES (1,'08455190249','01322553105','info@responseuksecurity.co.uk','Howbury House Thames Road Crayford DA1 4RQ\n','2023-03-05 01:59:34','2023-03-05 01:59:34');
...
CREATE TABLE `home_abouts` (
  ...
  `img1_subhead` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `img2` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `img2_subhead` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `home_qualities` (
  ...
  `image2` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `anim_delay` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `home_services` VALUES (1,'Our Services','Here is the collection of the quality services we offer. Please choose what you need, we are sure we have just the thing you are looking for','2023-02-24 13:43:04','2023-02-24 13:43:04');
...
CREATE TABLE `pages` (
  ...
  `page_url` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `pages` VALUES (1,'Home','/','2023-03-05 03:48:29','2023-03-05 03:48:29'),(2,'About','/about','2023-03-05 03:51:56','2023-03-05 03:51:56'),(3,'Services','/services','2023-03-05 03:53:57','2023-03-05 03:53:57'),(4,'Projects','/project','2023-03-05 03:57:12','2023-03-05 03:57:12'),(5,'Contact','/contact','2023-03-05 03:58:19','2023-03-05 03:58:19');
...
CREATE TABLE `quote_ctas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `cta` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `quote_ctas` VALUES (1,'Get a Quote','If there is something you need us to assist you with, please make a personalise quote to let us know about it','2023-03-05 01:19:42','2023-03-05 01:19:42');
...
CREATE TABLE `service_products` (
  ...
  `service_img` varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `service_products_type_id_foreign` (`page_id`),
  CONSTRAINT `service_products_page_id_foreign` FOREIGN KEY (`page_id`) REFERENCES `pages` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
--
...
-- Dump completed on 2023-03-05  7:55:02
