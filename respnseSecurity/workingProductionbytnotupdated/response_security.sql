...
--
-- Host: localhost:3306
-- Generation Time: Apr 19, 2023 at 08:14 AM
...
CREATE TABLE `about_vals` (
  `id` int(10) UNSIGNED NOT NULL,
  `mis_title, 50` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  ...
  `val_title, 50` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `brochures` (
  `id` int(10) UNSIGNED NOT NULL,
  `title` varchar(15) CHARACTER SET utf8mb4 NOT NULL,
  `content` varchar(15) CHARACTER SET utf8mb4 NOT NULL,
  `image` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `contacts` (`id`, `phone_no1`, `phone_no2`, `email`, `address`, `created_at`, `updated_at`) VALUES
(1, '08455190249', '01322553105', 'info@responseuksecurity.co.uk', 'Howbury House Thames Road Crayford DA1 4RQ\n', '2023-03-05 08:59:34', '2023-03-05 08:59:34');
...
INSERT INTO `home_abouts` (`id`, `title`, `content`, `img1`, `img1_subhead`, `img2`, `img2_subhead`, `created_at`, `updated_at`) VALUES
(1, 'About Us', 'Response UK Security Ltd are specialists at delivering bespoke security and surveillance services, like Retail Security Services, etc. With over 50 years’ experience working within the security industry, our management team is ...', NULL, NULL, NULL, NULL, '2023-02-19 20:59:53', '2023-02-19 20:59:53');
...
INSERT INTO `home_banners` (`id`, `title`, `content`, `image`, `created_at`, `updated_at`) VALUES
(1, 'CCTV  Security  and Solution', ' We provide that extra set of eyes to keep your valuables secured, 24hours everyday', 'carousel-1.jpg', '2023-02-19 17:35:44', '2023-02-19 17:35:44'),
(2, 'We are Flexible', 'We adapt and grow with your establishment and provide efficient solutions every step of the way', 'carousel-1.jpg', '2023-02-19 17:46:18', '2023-02-19 17:46:18'),
(3, 'Security Guard and protection for all Establishments', ' Our qualified and well train personels are ready to give the peace of mind you and your clients needs for an efficient business cooperation.', 'carousel-1.jpg', '2023-02-19 18:16:39', '2023-02-19 18:16:39');
...
INSERT INTO `home_qualities` (`id`, `title`, `content`, `image`, `image2`, `anim_delay`, `created_at`, `updated_at`) VALUES
(1, '100% Breach Prevention', 'Being one of the respected Construction Guarding Companies In Colchester, we pride ourselves on ensuring that the safety of you, your business and your staff is never breached and look to achieve maximum impact in the most cost effective way for all our clients.', 'breach-prevention.png', 'breach-prevention_dark.png', '0.1', '2023-02-19 19:57:17', '2023-02-19 19:57:17'),
(2, 'CCTV and Alarms', 'A professional alarmed response service will provide you with immediate response in case of theft or damage to your property or your staff. Alarmed response is available 24/7, and business owners can benefit from this service since disaster can strike at any moment – with little or no warning.', 'cctv-1.png', 'cctv-dark.png', '0.3', '2023-02-19 19:59:06', '2023-02-19 19:59:06'),
(3, 'SIA Lincense', 'We adhere to standard BS 7855, which stipulates the dos and don’ts of the security industry. All our staff are SIA licensed and appropriately selected to work in any part of the UK and at any sized organisation.', 'guarantee.png', 'guarantee-dark.png', '0.5', '2023-02-19 20:00:13', '2023-02-19 20:00:13');
...
INSERT INTO `home_services` (`id`, `title`, `content`, `created_at`, `updated_at`) VALUES
(1, 'Our Services', 'Here is the collection of the quality services we offer. Please choose what you need, we are sure we have just the thing you are looking for', '2023-02-24 20:43:04', '2023-02-24 20:43:04');
...
INSERT INTO `home_why_chooses` (`id`, `title`, `content`, `img`, `created_at`, `updated_at`) VALUES
(1, 'Why Choose Us', 'As with all security companies, loss prevention is at the core of what we do – but being able to deliver this in the most financially efficient way is what makes us stand out from other security firms.', 'feature.jpg', '2023-02-27 17:44:06', '2023-02-27 17:44:06');
...
(95, '2023_02_19_081740_create_home_banners_table', 1),
(96, '2023_02_19_082416_create_general_navs_table', 1),
(97, '2023_02_19_083042_create_home_qualities_table', 1),
(98, '2023_02_19_083900_create_home_abouts_table', 1),
(99, '2023_02_19_084135_create_home_services_table', 1),
(100, '2023_02_19_084517_create_service_highlights_table', 1),
(101, '2023_02_19_085124_create_home_why_chooses_table', 1),
(102, '2023_02_19_085409_create_about_banners_table', 1),
(103, '2023_02_19_090055_create_about_vals_table', 1),
(104, '2023_02_19_090519_create_brochures_table', 1),
(105, '2023_02_19_091004_create_service_banners_table', 1),
(106, '2023_02_19_091419_create_service_products_table', 1),
(107, '2023_03_04_070830_create_quotes_table', 2),
(108, '2023_03_04_123002_create_quote_ctas_table', 3),
...
CREATE TABLE `pages` (
  `id` int(10) UNSIGNED NOT NULL,
  `page_name` varchar(10) CHARACTER SET utf8mb4 NOT NULL,
  `page_url` varchar(10) CHARACTER SET utf8mb4 DEFAULT NULL,
...
INSERT INTO `pages` (`id`, `page_name`, `page_url`, `nav_style`, `nav_toggle`, `created_at`, `updated_at`) VALUES
(1, 'Home', '/', 'nav-item dropdown', 'nav-link ', '2023-03-05 10:48:29', '2023-03-05 10:48:29'),
(2, 'About', '/about', 'nav-item dropdown', 'nav-link ', '2023-03-05 10:51:56', '2023-03-05 10:51:56'),
(3, 'Services', '/services', 'nav-item dropdown', 'nav-link dropdown-toggle', '2023-03-05 10:53:57', '2023-03-05 10:53:57'),
(4, 'Projects', '/project', 'nav-item dropdown', 'nav-link ', '2023-03-05 10:57:12', '2023-03-05 10:57:12'),
(5, 'Contact', '/contact', 'nav-item dropdown', 'nav-link ', '2023-03-05 10:58:19', '2023-03-05 10:58:19');
...
INSERT INTO `quote_ctas` (`id`, `cta`, `content`, `created_at`, `updated_at`) VALUES
(1, 'Get a Quote', 'If there is something you need us to assist you with, please make a personalise quote to let us know about it', '2023-03-05 08:19:42', '2023-03-05 08:19:42');
...
--
-- Indexes for table `about_vals`
--
ALTER TABLE `about_vals`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `general_navs`
--
ALTER TABLE `general_navs`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `home_qualities`
--
ALTER TABLE `home_qualities`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `home_why_chooses`
--
ALTER TABLE `home_why_chooses`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `quote_ctas`
--
ALTER TABLE `quote_ctas`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `service_products`
  ADD PRIMARY KEY (`id`),
  ADD KEY `service_products_type_id_foreign` (`page_id`);
...
--
-- AUTO_INCREMENT for table `about_vals`
--
ALTER TABLE `about_vals`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `general_navs`
--
ALTER TABLE `general_navs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `home_qualities`
--
ALTER TABLE `home_qualities`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `home_why_chooses`
--
ALTER TABLE `home_why_chooses`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `quote_ctas`
--
ALTER TABLE `quote_ctas`
...
--
ALTER TABLE `service_products`
  ADD CONSTRAINT `service_products_page_id_foreign` FOREIGN KEY (`page_id`) REFERENCES `pages` (`id`) ON DELETE CASCADE;
COMMIT;
