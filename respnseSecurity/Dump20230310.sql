...
CREATE TABLE
  `about_banners` (
    ...
    `title` varchar(15) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `image` varchar(50) CHARACTER
    SET
      utf8mb4 NOT NULL,
...
CREATE TABLE
  `about_vals` (
    `id` int unsigned NOT NULL AUTO_INCREMENT,
    `mis_title, 50` varchar(255) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `mis_content` longtext CHARACTER
    SET
      utf8mb4 NOT NULL,
      `vis_title` varchar(50) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `vis_content` longtext CHARACTER
    SET
      utf8mb4 NOT NULL,
      `val_title, 50` varchar(255) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `val_content` longtext CHARACTER
    SET
      utf8mb4 NOT NULL,
      `created_at` timestamp NULL DEFAULT NULL,
      `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE
  `abouts` (
    `id` int unsigned NOT NULL AUTO_INCREMENT,
    `title_f` varchar(50) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `f_content` longtext CHARACTER
    SET
      utf8mb4 NOT NULL,
      `title_s` varchar(50) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `s_content` longtext CHARACTER
    SET
      utf8mb4 NOT NULL,
      `founder` varchar(100) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `created_at` timestamp NULL DEFAULT NULL,
      `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE
  `contacts` (
    `id` int unsigned NOT NULL AUTO_INCREMENT,
    `phone_no1` varchar(11) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `phone_no2` varchar(11) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `email` varchar(50) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `address` varchar(50) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `created_at` timestamp NULL DEFAULT NULL,
      `updated_at` timestamp NULL DEFAULT NULL,
...
VALUES
  (
    ...
    '08455190249',
    '01322553105',
    'info@responseuksecurity.co.uk',
    'Howbury House Thames Road Crayford DA1 4RQ\n',
    '2023-03-05 01:59:34',
    '2023-03-05 01:59:34'
  );
...
CREATE TABLE
  `failed_jobs` (
    ...
    SET
      utf8mb4 NOT NULL,
      `connection` text CHARACTER
    SET
      utf8mb4 NOT NULL,
      `queue` text CHARACTER
    SET
      utf8mb4 NOT NULL,
...
CREATE TABLE
  `home_abouts` (
    ...
    SET
      utf8mb4 NOT NULL,
      `img1` varchar(100) CHARACTER
    SET
      utf8mb4 DEFAULT NULL,
      `img1_subhead` varchar(100) CHARACTER
    SET
      utf8mb4 DEFAULT NULL,
      `img2` varchar(100) CHARACTER
    SET
      utf8mb4 DEFAULT NULL,
      `img2_subhead` varchar(100) CHARACTER
    SET
      utf8mb4 DEFAULT NULL,
      `created_at` timestamp NULL DEFAULT NULL,
      `updated_at` timestamp NULL DEFAULT NULL,
...
VALUES
  (
    1,
    'About Us',
    'Response UK Security Ltd are specialists at delivering bespoke security and surveillance services, like Retail Security Services, etc. With over 50 years’ experience working within the security industry, our management team is ...',
    NULL,
    NULL,
    NULL,
    NULL,
...
VALUES
  (
    1,
    'CCTV  Security  and Solution',
    ' We provide that extra set of eyes to keep your valuables secured, 24hours everyday',
    'carousel-1.jpg',
    '2023-02-19 10:35:44',
    '2023-02-19 10:35:44'
  ),
  (
    2,
    'We are Flexible',
    'We adapt and grow with your establishment and provide efficient solutions every step of the way',
    'carousel-1.jpg',
    '2023-02-19 10:46:18',
    '2023-02-19 10:46:18'
  ),
  (
    3,
    'Security Guard and protection for all Establishments',
    ' Our qualified and well train personels are ready to give the peace of mind you and your clients needs for an efficient business cooperation.',
    'carousel-1.jpg',
    '2023-02-19 11:16:39',
    '2023-02-19 11:16:39'
  );
...
CREATE TABLE
  `home_qualities` (
    ...
    SET
      utf8mb4 NOT NULL,
      `image` varchar(30) CHARACTER
    SET
      utf8mb4 DEFAULT NULL,
      `image2` varchar(30) CHARACTER
    SET
      utf8mb4 DEFAULT NULL,
      `anim_delay` varchar(5) CHARACTER
    SET
      utf8mb4 DEFAULT NULL,
      `created_at` timestamp NULL DEFAULT NULL,
      `updated_at` timestamp NULL DEFAULT NULL,
...
VALUES
  (
    ...
    'Being one of the respected Construction Guarding Companies In Colchester, we pride ourselves on ensuring that the safety of you, your business and your staff is never breached and look to achieve maximum impact in the most cost effective way for all our clients.',
    'breach-prevention.png',
    'breach-prevention_dark.png',
    '0.1',
    '2023-02-19 12:57:17',
    '2023-02-19 12:57:17'
  ),
  (
    2,
    'CCTV and Alarms',
    'A professional alarmed response service will provide you with immediate response in case of theft or damage to your property or your staff. Alarmed response is available 24/7, and business owners can benefit from this service since disaster can strike at any moment – with little or no warning.',
    'cctv-1.png',
    'cctv-dark.png',
    '0.3',
    '2023-02-19 12:59:06',
  ...
  (
    3,
    'SIA Lincense',
    'We adhere to standard BS 7855, which stipulates the dos and don’ts of the security industry. All our staff are SIA licensed and appropriately selected to work in any part of the UK and at any sized organisation.',
    'guarantee.png',
    'guarantee-dark.png',
    '0.5',
    '2023-02-19 13:00:13',
...
VALUES
  (
    1,
    'Our Services',
    'Here is the collection of the quality services we offer. Please choose what you need, we are sure we have just the thing you are looking for',
    '2023-02-24 13:43:04',
    '2023-02-24 13:43:04'
  );
...
VALUES
  (
    1,
    'Why Choose Us',
    'As with all security companies, loss prevention is at the core of what we do – but being able to deliver this in the most financially efficient way is what makes us stand out from other security firms.',
    'feature.jpg',
    '2023-02-27 10:44:06',
    '2023-02-27 10:44:06'
  );
...
VALUES
  ...
  (94, '2023_02_05_180610_create_abouts_table', 1),
  (
    95,
    '2023_02_19_081740_create_home_banners_table',
    1
  ),
  (
    96,
    '2023_02_19_082416_create_general_navs_table',
    1
  ),
  (
    97,
    '2023_02_19_083042_create_home_qualities_table',
    1
  ),
  (
    98,
    '2023_02_19_083900_create_home_abouts_table',
    1
  ),
  (
    99,
    '2023_02_19_084135_create_home_services_table',
    1
  ),
  (
    100,
    '2023_02_19_084517_create_service_highlights_table',
    1
  ),
  (
    101,
    '2023_02_19_085124_create_home_why_chooses_table',
    1
  ),
  (
    102,
    '2023_02_19_085409_create_about_banners_table',
    1
  ),
  (
    103,
    '2023_02_19_090055_create_about_vals_table',
    1
  ),
  (104, '2023_02_19_090519_create_brochures_table', 1),
  (
    105,
    '2023_02_19_091004_create_service_banners_table',
    1
  ),
  (
    106,
    '2023_02_19_091419_create_service_products_table',
    1
  ),
  (107, '2023_03_04_070830_create_quotes_table', 2),
  (
    108,
    '2023_03_04_123002_create_quote_ctas_table',
    3
  ),
  (109, '2023_03_05_015128_create_contacts_table', 4),
  (110, '2023_03_05_032505_create_pages_table', 5);
...
CREATE TABLE
  `pages` (
    `id` int unsigned NOT NULL AUTO_INCREMENT,
    `page_name` varchar(10) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `page_url` varchar(10) CHARACTER
    SET
      utf8mb4 DEFAULT NULL,
      `nav_style` varchar(50) DEFAULT NULL,
      `nav_toggle` varchar(50) DEFAULT NULL,
      `created_at` timestamp NULL DEFAULT NULL,
      `updated_at` timestamp NULL DEFAULT NULL,
      PRIMARY KEY (`id`)
  ) --
...
VALUES
  (
    1,
    'Get a Quote',
    'If there is something you need us to assist you with, please make a personalise quote to let us know about it',
    '2023-03-05 01:19:42',
    '2023-03-05 01:19:42'
  );
...
CREATE TABLE
  `quotes` (
    ...
    SET
      utf8mb4 NOT NULL,
      `company_name` varchar(50) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `email` varchar(50) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `mobile` varchar(50) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `address` varchar(50) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `service_type` varchar(50) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `security_no` varchar(50) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `location` varchar(50) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `start_date` varchar(255) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `end_date` varchar(255) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `note` varchar(255) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `reference_src` varchar(255) CHARACTER
    SET
      utf8mb4 NOT NULL,
      `created_at` timestamp NULL DEFAULT NULL,
      `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE
  `service_products` (
    ...
    SET
      utf8mb4 NOT NULL,
      `long_content` longtext CHARACTER
    SET
      utf8mb4 NOT NULL,
      `svg` longtext CHARACTER
    SET
      utf8mb4 NOT NULL,
      `service_img` varchar(255) CHARACTER
    SET
      utf8mb4 DEFAULT NULL,
      `created_at` timestamp NULL DEFAULT NULL,
      `updated_at` timestamp NULL DEFAULT NULL,
...
VALUES
  ...
  (
    ...
    3,
    'Concierge',
    'Being one of the prominent Security Companies in UK, Response UK Security Ltd we provide a comprehensive Concierge Security Services...',
...
CREATE TABLE
  ...
  --
  -- Dump completed on 2023-03-10 10:53:57