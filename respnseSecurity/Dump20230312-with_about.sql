...
CREATE TABLE `about_vals` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `mis_title, 50` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `val_title, 50` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `pages` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `page_name` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `page_url` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nav_style` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nav_toggle` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `pages` VALUES (1,'Home','/','nav-item dropdown','nav-link ','2023-03-05 03:48:29','2023-03-05 03:48:29'),(2,'About','/about','nav-item dropdown','nav-link ','2023-03-05 03:51:56','2023-03-05 03:51:56'),(3,'Services','/services','nav-item dropdown','nav-link dropdown-toggle','2023-03-05 03:53:57','2023-03-05 03:53:57'),(4,'Projects','/project','nav-item dropdown','nav-link ','2023-03-05 03:57:12','2023-03-05 03:57:12'),(5,'Contact','/contact','nav-item dropdown','nav-link ','2023-03-05 03:58:19','2023-03-05 03:58:19');
...
-- Dump completed on 2023-03-12 10:35:53
