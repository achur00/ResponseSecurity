...
CREATE TABLE `about_vals` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `mis_title` varchar(255) CHARACTER SET utf8mb4  NOT NULL,
  ...
  `val_title` varchar(255) CHARACTER SET utf8mb4  NOT NULL,
...
CREATE TABLE `personal_access_tokens` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tokenable_type` varchar(100) CHARACTER SET utf8mb4  NOT NULL,
...
-- Dump completed on 2023-04-19 21:40:35
