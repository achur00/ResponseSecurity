...
CREATE TABLE `about_vals` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `mis_title` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `mis_content` longtext CHARACTER SET utf8mb4  NOT NULL,
  `vis_title` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `vis_content` longtext CHARACTER SET utf8mb4  NOT NULL,
  `val_title` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `val_content` longtext CHARACTER SET utf8mb4  NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `abouts` (
  ...
  `title_f` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `f_content` longtext CHARACTER SET utf8mb4  NOT NULL,
  `title_s` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `s_content` longtext CHARACTER SET utf8mb4  NOT NULL,
  `founder` varchar(100) CHARACTER SET utf8mb4  NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `brochures` VALUES (1,'Download Our Brochure','PLease download our catalogue to see all the services we offer and to also learn how we can help.','response_brochure.png','2023-05-03 16:57:49','2023-05-03 16:57:49');
...
CREATE TABLE `contacts` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `phone_no1` varchar(11) CHARACTER SET utf8mb4  NOT NULL,
  `phone_no2` varchar(11) CHARACTER SET utf8mb4  NOT NULL,
...
CREATE TABLE `failed_jobs` (
  ...
  `uuid` varchar(100) CHARACTER SET utf8mb4  NOT NULL,
...
CREATE TABLE `general_navs` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `nav_name` varchar(20) CHARACTER SET utf8mb4  NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ;
...
CREATE TABLE `home_qualities` (
  ...
  `title` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `content` longtext CHARACTER SET utf8mb4  NOT NULL,
  `image` varchar(30) CHARACTER SET utf8mb4  DEFAULT NULL,
  `image2` varchar(30) CHARACTER SET utf8mb4  DEFAULT NULL,
  `anim_delay` varchar(5) CHARACTER SET utf8mb4  DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 ;
...
INSERT INTO `newsletters` VALUES (1,'Newsletter','Subscribe to our news letter to get important and recent updates about us','2023-05-03 21:12:19','2023-05-03 21:12:19');
...
CREATE TABLE `quote_ctas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `cta` varchar(50) CHARACTER SET utf8mb4  DEFAULT NULL,
...
CREATE TABLE `quotes` (
  ...
  `company_name` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `email` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `mobile` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `address` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `service_type` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `security_no` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `location` varchar(50) CHARACTER SET utf8mb4  NOT NULL,
  `start_date` varchar(255) CHARACTER SET utf8mb4  NOT NULL,
  `end_date` varchar(255) CHARACTER SET utf8mb4  NOT NULL,
  `note` varchar(255) CHARACTER SET utf8mb4  NOT NULL,
  `reference_src` varchar(255) CHARACTER SET utf8mb4  NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 ;
...
CREATE TABLE `service_products` (
  ...
  `long_content` longtext CHARACTER SET utf8mb4  NOT NULL,
  `svg` longtext CHARACTER SET utf8mb4  NOT NULL,
  `service_img` varchar(255) CHARACTER SET utf8mb4  DEFAULT NULL,
  `img_position` varchar(100) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `service_products_page_id_foreign` (`page_id`),
  CONSTRAINT `service_page_id_page_id_foreign` FOREIGN KEY (`page_id`) REFERENCES `pages` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2023-05-04  1:12:51
