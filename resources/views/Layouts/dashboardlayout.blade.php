...
<head>
  ...
  <!-- build:css({.tmp,app}) styles/app.min.css -->
    <link rel="stylesheet" href="{{asset('assets/dashboard/vendor/datatables/media/css/datatables.bootstrap.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/styles/webfont.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/styles/climacons-font.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/vendor/bootstrap/dist/css/bootstrap.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/styles/font-awesome.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/styles/card.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/styles/sli.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/styles/animate.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/styles/app.css')}}">
  <link rel="stylesheet" href="{{asset('assets/dashboard/styles/app.skins.css')}}">
...
<body class="page-loading">
  ...
  <div class="app layout-fixed-header">
          ...
          <li>
            ...
            <ul class="dropdown-menu notifications">
              <li class="notifications-header">
                <p class="text-dark small">You have 3 new messages</p>
              </li>
              <li>
    ...
    <div class="main-content">
         <div class="row" style="border-radius:3%;">
            <div class="col">
      ...
      <div class="chat-inner">
        ...
        <div class="chat-conversation">
          ...
          <div class="chat-conversation-content">
            <p class="text-center text-dark small text-uppercase bold pb15">
              Yesterday
            </p>
  ...
  <script src="{{asset('assets/dashboard/scripts/helpers/modernizr.js')}}"></script>
  <script src="{{asset('assets/dashboard/vendor/jquery/dist/jquery.js')}}"></script>
  <script src="{{asset('assets/dashboard/vendor/bootstrap/dist/js/bootstrap.js')}}"></script>
  <script src="{{asset('assets/dashboard/vendor/fastclick/lib/fastclick.js')}}"></script>
  <script src="{{asset('assets/dashboard/vendor/perfect-scrollbar/js/perfect-scrollbar.jquery.js')}}"></script>
  <script src="{{asset('assets/dashboard/scripts/helpers/smartresize.js')}}"></script>
  <script src="{{asset('assets/dashboard/scripts/constants.js')}}"></script>
  <script src="{{asset('assets/dashboard/scripts/main.js')}}"></script>
  <!-- endbuild -->
  <!-- page scripts -->
  <script src="{{asset('assets/dashboard/vendor/flot/jquery.flot.js')}}"></script>
  <script src="{{asset('assets/dashboard/vendor/flot/jquery.flot.resize.js')}}"></script>
  <script src="{{asset('assets/dashboard/vendor/flot/jquery.flot.categories.js')}}"></script>
  <script src="{{asset('assets/dashboard/vendor/flot/jquery.flot.stack.js')}}"></script>
  <script src="{{asset('assets/dashboard/vendor/flot/jquery.flot.time.js')}}"></script>
  <script src="{{asset('assets/dashboard/vendor/flot/jquery.flot.pie.js')}}"></script>
  <script src="{{asset('assets/dashboard/vendor/flot-spline/js/jquery.flot.spline.js')}}"></script>
  <script src="{{asset('assets/dashboard/vendor/flot.orderbars/js/jquery.flot.orderBars.js')}}"></script>
  <!-- end page scripts -->
  <!-- initialize page scripts -->
  <script src="{{asset('assets/dashboard/scripts/helpers/sameheight.js')}}"></script>
  <script src="{{asset('assets/dashboard/scripts/ui/dashboard.js')}}"></script>
  <!-- end initialize page scripts -->

  {{-- data table --}}
  <!-- page scripts -->
  <script src="{{asset('assets/dashboard/vendor/datatables/media/js/jquery.dataTables.js')}}"></script>
  <!-- end page scripts -->
  <!-- initialize page scripts -->
  <script src="{{asset('assets/dashboard/vendor/datatables/media/js/datatables.bootstrap.js')}}"></script>
