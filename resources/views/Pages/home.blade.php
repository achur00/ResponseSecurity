                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="h-100 bg-dark p-4 p-xl-5 rounded">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <h1 class="display-1 mb-0" style="color: #383838;">%</h1>
                        </div>
                        <h5 class="text-white">100% Breach Prevention</h5>
                        <hr class="w-25">
                        <span>Being one of the respected Construction Guarding Companies In Colchester, we pride ourselves on ensuring that the safety of you, your business and your staff is never breached and look to achieve maximum impact in the most cost effective way for all our clients.    </span>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="h-100 bg-dark p-4 p-xl-5 rounded">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                          ...
                          <img class="img-fluid display-1 mb-0" style="color: #383838" src="{{asset('assets/img/icon/alarm2.png')}}" alt="alarm-clock">
                        </div>
                        <h5 class="text-white">CCTV and Alarms</h5>
                        <hr class="w-25">
                    ...
                    <div class="h-100 bg-dark p-4 p-xl-5 rounded">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div class="btn-square rounded-circle" style="width: 70px; height: 70px; background: #000000;">
								...
								<span class="fi fi-ss-badge text-danger" style="font-size:40px">
                            </div>
                           
                            <span class="img-fluid display-1 mb-0 fi-ss-badge-check " style="font-size:70px; color:#383838">
                        </div>
                        <h5 class="text-white">SIA Lincense</h5>
                        <hr class="w-25 bg-white">
                        <span>We adhere to standard BS 7855, which stipulates the dos and don’ts of the security industry. All our staff are SIA licensed and appropriately selected to work in any part of the UK and at any sized organisation.
            ...
            <div class="row g-0 mx-lg-0">
                ...
                <div class="col-lg-6 about-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        ...
                        <p class="mb-4 pb-2 text-light">Response UK Security Ltd are specialists at delivering bespoke security and surveillance services, like Retail Security Services, etc. With over 50 years’ experience working within the security industry, our management team is ...</p>
